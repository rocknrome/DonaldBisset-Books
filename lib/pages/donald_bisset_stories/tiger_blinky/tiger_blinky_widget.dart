...
import 'tiger_blinky_model.dart';
export 'tiger_blinky_model.dart';

class TigerBlinkyWidget extends StatefulWidget {
...
class _TigerBlinkyWidgetState extends State<TigerBlinkyWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TigerBlinkyModel());
  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          backgroundColor: const Color(0xFFEC972C),
          automaticallyImplyLeading: false,
          leading: Padding(
            padding: const EdgeInsetsDirectional.fromSTEB(10.0, 0.0, 0.0, 10.0),
            child: FlutterFlowIconButton(
              borderColor: const Color(0xFFEC972C),
              borderRadius: 20.0,
              borderWidth: 1.0,
              buttonSize: 40.0,
                          ...
                          await Navigator.push(
                            ...
                            PageTransition(
                              ...
                              child: FlutterFlowExpandedImageView(
                                image: Image.asset(
                                  'assets/images/pro-tigrenka-binki-u-kotorogo-ischezli-vse-poloski1-1.jpg.webp',
                                  fit: BoxFit.contain,
                                ),
                                allowRotation: true,
                                tag: 'imageTag1',
                        ...
                        onTap: () async {
                          await Navigator.push(
                            ...
                            PageTransition(
                              ...
                              child: FlutterFlowExpandedImageView(
                                image: Image.asset(
                                  'assets/images/pro-tigrenka-binki-u-kotorogo-ischezli-vse-poloski3.jpg.webp',
                                  fit: BoxFit.contain,
                                ),
                                allowRotation: true,
                                tag: 'imageTag3',
                        ...
                        onTap: () async {
                          await Navigator.push(
                            ...
                            PageTransition(
                              ...
                              child: FlutterFlowExpandedImageView(
                                image: Image.asset(
                                  'assets/images/pro-tigrenka-binki-u-kotorogo-ischezli-vse-poloski4.jpg.webp',
                                  fit: BoxFit.contain,
                                ),
                                allowRotation: true,
                                tag: 'imageTag4',
                        ...
                        onTap: () async {
                          await Navigator.push(
                            ...
                            PageTransition(
                              ...
                              child: FlutterFlowExpandedImageView(
                                image: Image.asset(
                                  'assets/images/pro-tigrenka-binki-u-kotorogo-ischezli-vse-poloski5.jpg.webp',
                                  fit: BoxFit.contain,
                                ),
                                allowRotation: true,
                                tag: 'imageTag5',
